import { Bubble1, Bubble2, Cursor } from "@components/vector";
        ...
        <footer className="bg-primary-default">
            ...
            <div className="h-[802px] w-[100% flex-col flex justify-around">
                ...
                <div className="md:hidden text-center">
                    ...
                    {/* <div className="text-primary-contrast w-[224] h-[48] border-2 border-solid border-primary-light text-center mt-[14px] mb-[44px]">Join the adventure!</div> */}
                ...
                <div className="md:flex justify-center hidden">
                    <div className="flex-col mr-[106px] text-right">
                        ...
                        {/* <div className="text-primary-contrast w-[224] h-[48] border-2 border-solid border-primary-light text-center mt-[32px] mb-[44px]">Join the adventure!</div> */}
                    </div>
                    <div className="flex-col">
                        ...
                        {/* <div className="text-primary-contrast w-[224] h-[48] border-2 border-solid border-primary-light text-center mt-[32px] mb-[44px]">Kontaktiere uns!</div> */}
                    </div>
                </div>
                <div className="">
            ...
            <div className="relative bottom-0 left-0 w-[100%] h-[6.33vh] overflow-hidden">
                ...
                {/* <img className="w-[100%] h-[100%] object-cover object-top " src="public\images\logo-02.svg" alt="logo" /> */}
            </div>
        </footer>
    )
}