...
export function Header({ }: Header) {
    ...
    return (
        <header className="fixed w-full justify-center shadow-[0_2px_4px_-1px_rgba(0,0,0,0.2)] md:flex z-10 bg-primary-contrast">
            ...
            <div className="bt-button-1 w-[42.26px] h-[43px] absolute top-[16.37px] right-[37.74px] hover:opacity-75 md:hidden" onClick={() => setopen(!open)}>
                <svg className="" width="45" height="46" viewBox="0 0 45 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        ...
                        {!open && (
                            <>
                                <line x1="12" y1="23" x2="30" y2="23" stroke="#FFFFFF" stroke-width="2" />
                                <line x1="12" y1="28" x2="30" y2="28" stroke="#FFFFFF" stroke-width="2" />
                            </>
                        )}
                        {open && (
                            <>
