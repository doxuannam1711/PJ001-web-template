...
export function ButtonOutline({ className = "", textClassName = "", children, props }: ButtonOutline) {
    return <button  {...props}
        className={`border-[2px] hover:border-[0px] border-primary-light hover:bg-primary-light text-primary-default hover:text-primary-contrast rounded-full ${className}`}>
