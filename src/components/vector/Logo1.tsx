    ...
    return <>
        <div className="hidden sm:block">
            <Bubble1 size={sizeDesktop} className={desktopClassName}>
                <p className={`text-[120px] leading-[132px] tracking-[-1.65px] text-primary-contrast ${textClassName}`}>ICG</p>
            </Bubble1></div>
        <div className="block sm:hidden">
            <Bubble2 size={sizeMobile} className={mobileClassName}>
                <p className={`text-[95px] leading-[104.8px] tracking-[-1.31px] text-primary-contrast ${textClassName}`}>ICG</p>
            </Bubble2 >
        </div>
    </>
}