...
export function Bubble1({ children, size, className = "" }: Bubble1) {
    return <svg width={size} height={size} viewBox="0 0 447 447" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
