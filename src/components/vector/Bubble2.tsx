...
export function Bubble2({ children, size, className = "" }: Bubble2) {
    return <svg width={size} height={size} viewBox="0 0 326 326" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <linearGradient id="paint0_linear_277_64965" x1="163.193" y1="38.7778" x2="163.193" y2="278.282" gradientUnits="userSpaceOnUse">
                ...
                <stop offset="1" stop-color="#6C151C" />
            </linearGradient>
