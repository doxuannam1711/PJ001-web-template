...
export function DomainsCard({
  ...
  return (
    ...
    `}
      >
        <div className="px-[88px] md:px-0 md:max-h-[100vh] w-[calc(100vw-64px)] max-sm:h-full md:w-[460px] flex justify-center overflow-hidden">
          <img
            src={imageUrl}
            alt=""
            className="image-mask max-w-[3] h-full object-cover"
          />
        </div>

        <div className="content text-center mt-[40px] w-[calc(100vw-64px)] lg:text-start md:flex md:flex-col lg:items-start">
