...
export function DomainsCard({
  ...
  return (
    ...
    <>
      ...
      <div
        className={`
        flex-col grow items-center w-full md:min-h-[80vh] xl:gap-[84px] md:gap-[64px] lg:flex-row-reverse md:items-center md:justify-center md:basis-full flex-1 md:px-[20%] lg:px-[10%] flex scroll-mx-[32px] md:scroll-mx-[150px] ${className}
    `}
      >
